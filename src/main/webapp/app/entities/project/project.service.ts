...
export class ProjectService {
  ...
  protected convertDateFromClient(project: IProject): IProject {
    const copy: IProject = Object.assign({}, project, {
      registrationDate:
        project.registrationDate != null && project.registrationDate.isValid() ? project.registrationDate.format(DATE_FORMAT) : null
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((project: IProject) => {
        project.registrationDate = project.registrationDate != null ? moment(project.registrationDate) : null;
      });
    }
    return res;
  }
