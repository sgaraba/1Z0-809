...
describe('Project e2e test', () => {
  ...
  it('should load Projects', async () => {
    ...
    expect(await projectComponentsPage.getTitle()).to.eq('volunteerApp.project.home.title');
  });
  ...
  it('should load create Project page', async () => {
    ...
    expect(await projectUpdatePage.getPageTitle()).to.eq('volunteerApp.project.home.createOrEditLabel');
  ...
  it('should create and save Projects', async () => {
    ...
    await promise.all([
      ...
      projectUpdatePage.setRegistrationDateInput('2000-12-31'),
      projectUpdatePage.statusSelectLastOption(),
      projectUpdatePage.categorySelectLastOption(),
      // projectUpdatePage.userSelectLastOption(),
      projectUpdatePage.ongSelectLastOption()
    ]);
    ...
    expect(await projectUpdatePage.getRegistrationDateInput()).to.eq(
      '2000-12-31',
  ...
  it('should delete last Project', async () => {
    ...
    expect(await projectDeleteDialog.getDialogTitle()).to.eq('volunteerApp.project.delete.question');
