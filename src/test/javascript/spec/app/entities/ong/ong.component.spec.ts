...
import { OngComponent } from 'app/entities/ong/ong.component';
import { OngService } from 'app/entities/ong/ong.service';
import { Ong } from 'app/shared/model/ong.model';

describe('Component Tests', () => {
  describe('Ong Management Component', () => {
    let comp: OngComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ongs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
