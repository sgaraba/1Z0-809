...
import { VolunteerRequestComponent } from 'app/entities/volunteer-request/volunteer-request.component';
...
describe('Component Tests', () => {
  describe('VolunteerRequest Management Component', () => {
    let comp: VolunteerRequestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VolunteerRequestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.volunteerRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
